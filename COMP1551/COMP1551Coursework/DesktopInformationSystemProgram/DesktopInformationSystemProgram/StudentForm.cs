...
namespace DesktopInformationSystemProgram
{
    public partial class StudentForm : Form
    {
        ...
        {
            InitializeComponent();
            dbFunctions = new DatabaseFunctions(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\COMP1551Coursework\DesktopInformationSystemProgram\DesktopInformationSystemProgram\Database1.mdf;Integrated Security=True");
        }

        private void btn_load_Click(object sender, EventArgs e)
        {
            string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\COMP1551Coursework\DesktopInformationSystemProgram\DesktopInformationSystemProgram\Database1.mdf;Integrated Security=True";
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            Student student = new Student
            {
                ...
                phone = tb_phone.Text,
                email = tb_email.Text,
                subject1 = tb_subject1.Text,
                subject2 = tb_subject2.Text,
